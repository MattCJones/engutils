...
T_inf_truth_arr = [288.15, 255.67554322, 223.25209265, 216.65, 216.65,
...
p_inf_truth_arr = [1.01325000e+05, 5.40482622e+04, 2.64998731e+04,
        1.21117861e+04, 5.52929078e+03, 2.54921293e+03, 1.19702628e+03,
        5.74591263e+02, 2.87142182e+02, 1.49100428e+02, 7.97788547e+01,
        4.25248048e+01, 2.19584937e+01, 1.09296242e+01, 5.22085015e+00,
        2.38812369e+00, 1.05246447e+00] * unit('Pa')
rho_inf_truth_arr = [1.22500002e+00, 7.36428613e-01, 4.13510330e-01,
        1.94754547e-01, 8.89096382e-02, 4.00837567e-02, 1.84101009e-02,
        8.46333291e-03, 3.99565628e-03, 1.96626868e-03, 1.02687569e-03,
        5.68095211e-04, 3.09675594e-04, 1.63208648e-04, 8.28279701e-05,
        3.99207802e-05, 1.84578859e-05] * unit('kg/m^3')
a_inf_truth_arr = [340.29398803, 320.54540686, 299.53166026, 295.06949351,
        295.06949351, 298.38903875, 301.70866004, 308.29949587, 317.18924664,
        325.82322113, 329.798731,   323.72379141, 315.0734446,  306.19285211,
        297.06133141, 289.39626128, 282.53793156] * unit('m/s')
nu_inf_truth_arr = [1.46071857e-05, 2.21100607e-05, 3.52509330e-05,
        7.29951161e-05, 1.59894147e-04, 3.61349481e-04, 8.01340459e-04,
        1.80625312e-03, 4.00667357e-03, 8.49961937e-03, 1.65908919e-02,
...
class TestStandardAtm(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.h_geop_arr = h_geop_arr
        self.T_inf_arr = T_inf_arr
        self.p_inf_arr = p_inf_arr
        self.rho_inf_arr = rho_inf_arr
